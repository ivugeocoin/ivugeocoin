...
#define PACKAGE_BUGREPORT "info@ivugeocoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "IvugeoCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "IvugeoCoin Core 1.6.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ivugeocoin"
