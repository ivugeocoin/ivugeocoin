/**
 * Will complete port of the new block browser post-update.
**/
...
std::string getBlockHash(int Height)
{
    ...
    if(Height > pindex->nHeight) { return "351c6703813172725c6d660aa539ee6a3d7a9fe784c87fae7f36582e3b797058"; }
