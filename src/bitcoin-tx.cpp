...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("IvugeoCoin Core ivugeocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ivugeocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ivugeocoin transaction") + "\n" +
              "  ivugeocoin-tx [options] -create [commands]   " + _("Create hex-encoded ivugeocoin transaction") + "\n" +
              "\n";
